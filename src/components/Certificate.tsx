...
const CertificateComponent = (props: Props) => {
  ...
  const items: CarouselItem[] = [
    ...
    {
      position: 3,
      el: document.getElementById('carousel-item-4') as HTMLElement || null ,
    },
  ...
  const options: CarouselOptions = {
    ...
    indicators: {
      ...
      items: [
        {
          position: 0,
          el: document.getElementById('carousel-indicator-1') as HTMLElement || null
        },
        {
          position: 1,
          el: document.getElementById('carousel-indicator-2') as HTMLElement || null
        },
        {
          position: 2,
          el: document.getElementById('carousel-indicator-3') as HTMLElement || null
        },
        {
          position: 3,
          el: document.getElementById('carousel-indicator-4') as HTMLElement || null
        },
      ]
    },
